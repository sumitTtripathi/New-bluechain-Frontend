  ...
  return (
    <StyledAboutCoinPopover>
      ...
      <div className="basic-info-details">
        ...
        {/* <div className="details-container">
          <div className="details">
            <p className="label">Total Circulation</p>
            <p className="value">19.29M</p>
          </div>
          <div className="details">
            <p className="label">Total Market Cap(USD)</p>
            <p className="value">
        ...
        {/* <div className="details-container">
          <div className="details">
            <p className="label">Circulating Market Cap(USD)</p>
            <p className="value">20.44B</p>
          </div>
        </div> */}
      </div>
      <div className="basic-info-details">
        ...
        <div className="links-container">
          ...
          <a href="/" target="_blank" rel="noreferrer">
            Coin <FaExternalLinkAlt size={12} className="link-icon" />
          </a>
          <a href="/" target="_blank" rel="noreferrer">
            Margin <FaExternalLinkAlt size={12} className="link-icon" />
          </a>
          <Dropdown
            menu={{
          ...
          <a href="/" target="_blank" rel="noreferrer">
            Wallet <FaExternalLinkAlt size={12} className="link-icon" />
          </a>
          <a
            target="_blank"
            rel="noreferrer"
