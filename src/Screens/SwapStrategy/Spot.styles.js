...
export const StyledSpotContainer = styled.div`
  ...
  .input-color {
    background: ${(props) => props.theme.colors.darkBlack} !important;
    height: 48px;
    width: 100%;
    border-radius: 8px;
    border: none;
  ...
  .close-btn {
    border: 1px solid ${(props) => props.theme.borders.border7} !important;
    white-space: nowrap;
    padding: 4px 6px;
...
export const HistoryContainer = styled.div`
  ...
  .otp-input {
    background: ${(props) => props.theme.colors.grey.semiLight} !important;
  ...
  .transfer-type {
    background: ${(props) => props.theme.colors.withdrawContainer};
    padding: 5px 10px;
    border: 1px solid ${(props) => props.theme.colors.grey.semiLight} ;
    border-radius: 8px;
    cursor: pointer;
  }
  .flex-box {
...
export const OrdersContainer = styled.div`
  ...
  .ant-table-cell .Popconfirm-bottom {
