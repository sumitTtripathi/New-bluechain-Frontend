...
const LimitBuyAdvancedModal = ({
  ...
  return (
    ...
    >
      ...
      <ValueLabel label={"Mark price"} value={`$${markPrice?.data?.markPx}`} />
      <div
        className="flex"
        onClick={() => {
          ...
          {priceSetting === "price" && (
            <>
              <div className="input-with-select">
                ...
                <Form.Item name="slPercent" className="w-30">
                  <Input
                    autocomplete="off"
...
// />
export default LimitBuyAdvancedModal;
