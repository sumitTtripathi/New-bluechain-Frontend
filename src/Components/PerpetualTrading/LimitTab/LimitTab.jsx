...
const LimitTab = ({ baseAsset, quoteAsset, leverageMode, leverage }) => {
  ...
  useEffect(() => {
    ...
    if (sellCurrency === "Crypto") {
      ...
      setMaxSellValue(Number(availableBal?.[0]?.free));
    }
