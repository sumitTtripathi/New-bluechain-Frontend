  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const formObj = {
        ...
        callbackSpread: buyVarianceValue === "percentage" ? "" : values.price,
  ...
  const handleSellSubmit = async (values) => {
    try {
      ...
      const formObj = {
        ...
        callbackSpread: sellVarianceValue === "percentage" ? "" : values.price,
            ...
            suffix={
              <>
                <span className="label">
                  {buyVarianceValue === "percentage" ? "%" : buyVarianceValue}
                </span>
              </>
            }
            prefix={
        ...
        >
          <Input
            ...
            suffix={
              <>
                <span className="label">
                  {sellVarianceValue === "percentage" ? "%" : sellVarianceValue}
                </span>
              </>
            }
            className="input"
