...
const SwapManualTrading = forwardRef(
  ({ baseAsset, quoteAsset, spotForm }, ref) => {
    ...
    const [stopValue, setStopValue] = useState("Manual");
...
SwapManualTrading.displayName = "SwapManualTrading";

export default SwapManualTrading;
