...
import { setChildrenDrawer } from "../../Services/Auth";
import { RiSettings5Fill } from "react-icons/ri";
import AboutCoinPopover from "../../Screens/SwapStrategy/AboutCoinPopover/AboutCoinPopover";

const TvBar = ({ baseAsset, quoteAsset, hlCoinPriceData }) => {
    ...
    <div className="coin-nav">
      ...
      <div style={{ display: "flex", gap: "10px", alignItems: "baseline" }}>
        ...
        <RiSettings5Fill
          ...
          onClick={() => dispatch(setChildrenDrawer(true))}
        />
      </div>
      <InnerAccountDrawer />
    </div>
